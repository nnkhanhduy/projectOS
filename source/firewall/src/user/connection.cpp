...
lệnh (ví dụ add_rule) từ CLI, nó sẽ parse và gọi bpf_map_update_elem để cập
nhật trực tiếp vào BPF Map trong kernel
*/
...
// NHẬN JSON TỪ CLI, PARSE LỆNH (ADD RULE / REMOVE RULE ) VÀ GỌI BPF_MAP_UPDATE_ELEM ĐỂ CẬP NHẬT KERNEL MAP
